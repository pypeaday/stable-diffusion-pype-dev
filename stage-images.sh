#!/bin/bash
#
echo "InvokeAI images are broken... Need to setup Docker/Nvidia on my new computer, and get the old version working again because of pytorch/CUDA requirements"
